                            ...
                            <div class="card-body pt-4">
                                ...
                                <div
                                    ...
                                    <div class="navi-item mb-2">
                                        <a href="{{ route('user.personal') }}" class="navi-link py-4 active">
                                    ...
                                    <div class="navi-item mb-2">
                                        <a href="{{ route('user.password') }}" class="navi-link py-4">
                                            <span class="navi-icon mr-2">
                                                <span class="svg-icon">
                        ...
                        <div class="card card-custom card-stretch">
                            ...
                            <div class="card-header py-3">
                                <div class="card-title align-items-start flex-column">
                                    <h3 class="card-label font-weight-bolder text-dark">Informações Pessoais</h3>
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">
                                        Atualize suas informações pessoais
                                    </span>
                                </div>
                                <div class="card-toolbar">
                                    <button type="reset" id="update-personal-info"
                                        class="btn btn-success mr-2">Atualizar</button>
                                </div>
                            </div>

                            <form class="form" action="{{ route('user.personal.update') }}" method="POST"
                                id="form-personal-info">
                                @csrf

                                <div class="card-body">
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">Imagem</label>
                                        <div class="col-lg-9 col-xl-6">
                                            ...
                                            <span class="form-text text-muted">Formatos aceitos: png, jpg, jpeg.</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">Nome completo</label>
                                        <div class="col-lg-9 col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">CPF</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input name="cpf" class="form-control form-control-lg form-control-solid cpf"
                                                type="text" value="{{ Auth::user()->cpf }}" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-xl-3"></label>
                                        <div class="col-lg-9 col-xl-6">
                                            <h5 class="font-weight-bold mt-10 mb-6">Informações de Contato</h5>
                                        </div>
                                    </div>
                                    <div class="form-group row">
