var KTSubmenus = function () {
    var submenus = function () {
        $('#submenus_table').KTDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
                        url: $('#submenus_table').attr("data-source"),
                        method: "GET",
                        map: function (raw) {
                            var dataSet = raw;
            ...
            search: {
                input: $('#submenus_table_search_query'),
                key: 'generalSearch'
            },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (e) {
                        return '\
                        <a class="btn-restore h4" href="submenus/' + e.id + '">\
        ...
        $('#submenus_table').on('datatable-on-ajax-done', function () {
            $(function () {
