var KTSubmenuUpdate = function () {
    var _handleSubmenuForm = function () {
        var validation;
        $('#menu_id').select2({placeholder: "Selecione um módulo"})
            ...
            KTUtil.getById('new_submenu'),
            {
                fields: {
                    ...
                    route: {
                        validators: {
                            notEmpty: {
                                message: 'Você precisa informar uma rota'
                            }
                        }
                    }
                },
                ...
                if (status == 'Valid') {
                    FormValidation.utils.fetch(formSubmitUrl, {
                        ...
                        if (response.result === 'success') {
                            toastr.success('Submenu alterado com sucesso.')
                            setTimeout(function () {
