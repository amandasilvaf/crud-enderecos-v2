var KTMenus = function () {
    var menus = function () {
        $('#menus_table').KTDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
                        url: $('#menus_table').attr("data-source"),
                        method: "GET",
                        map: function (raw) {
                            var dataSet = raw;
            ...
            search: {
                input: $('#menus_table_search_query'),
                key: 'generalSearch'
            },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (e) {
                        return '\
                        <a class="btn-restore h4" href="menus/' + e.id + '">\
        ...
        $('#menus_table').on('datatable-on-ajax-done', function () {
            $(function () {
                    ...
                    $.ajax({
                        ...
                        statusCode: {
                            204: function () {
                                ...
                                $('#menus_table').KTDatatable('reload')
                            },
