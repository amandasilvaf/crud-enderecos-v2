var KTModules = function () {
    var modules = function () {
        $('#modules_table').KTDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
                        url: $('#modules_table').attr("data-source"),
                        method: "GET",
                        map: function (raw) {
                            var dataSet = raw;
            ...
            search: {
                input: $('#modules_table_search_query'),
                key: 'generalSearch'
            },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (e) {
                        return '\
                        <a class="btn-restore h4" href="modulos/' + e.id + '">\
        ...
        $('#modules_table').on('datatable-on-ajax-done', function () {
            $(function () {
